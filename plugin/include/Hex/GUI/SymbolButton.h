...
class SymbolButton
    : public juce::ShapeButton {  //! nice utility for making shape buttons with
                                  //! simple symbols
public:
  SymbolButton(juce::String name = "symbol_button",
               juce::Colour _bkgnd = UXPalette::lightGray,
               juce::Colour sColour = UXPalette::highlight)
      : juce::ShapeButton(name, _bkgnd, _bkgnd, _bkgnd),
        upBkgnd(_bkgnd),
        downBkgnd(_bkgnd.darker(0.3f)),
...
public:
  ArrowButton(juce::String name = "arrow_button",
              juce::Colour bkgnd = UXPalette::lightGray,
              juce::Colour sColour = UXPalette::highlight);
